...
/**
 * Thread-safe maar inefficiente versie
 * (elke klant moet wachten tot de bestelling van de vorige klant volledig afgerond is)
 */
public class BookingSystem_V1 {
    ...
    public synchronized List<String> bookSeats(String customer, int requestedSeats) {
    ...
    public static void main(String[] args) {
        var nbCustomers = 20;
        var bookingSystem = new BookingSystem_V1();
